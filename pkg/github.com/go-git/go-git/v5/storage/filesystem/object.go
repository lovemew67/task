...
import (
	...
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/format/idxfile"
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/format/objfile"
