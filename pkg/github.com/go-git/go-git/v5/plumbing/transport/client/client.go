...
import (
	...
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/transport/file"
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/transport/git"
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/transport/http"
	"github.com/go-task/task/v3/pkg/github.com/go-git/go-git/v5/plumbing/transport/ssh"
)
