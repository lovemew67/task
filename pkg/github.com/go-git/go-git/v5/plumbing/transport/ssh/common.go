...
import (
	...
	"github.com/go-task/task/v3/pkg/github.com/skeema/knownhosts"

	"github.com/go-task/task/v3/pkg/github.com/kevinburke/ssh_config"
	"github.com/go-task/task/v3/pkg/golang.org/x/crypto/ssh"
	"github.com/go-task/task/v3/pkg/golang.org/x/net/proxy"
)
